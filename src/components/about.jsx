    ...
    <div className="w-full mt-8 items-center flex flex-col space-y-10 md:flex-row md:space-x-4">
      <div className="flex flex-col w-[80%] md:w-[70%] px-7 md:px-3 py-7 space-y-4 text-left ">
        ...
        <div className="text-customGray text-[18px]">
          <p>Hello! I'm Rishabh Srivastava, from Varanasi, also known as City of Ghats and Salavation of India.</p> <br/>
          ...
          <p>I am pursuing my Bachelors from <span className="text-customTeal">MANIT, Bhopal</span> in Computer Science and Engineering (2022-2026) my current GPA is <span className="text-customTeal">8.45</span> out of 10.</p> <br />

          <p>I am a <span className="text-customTeal">Technical Head at Intellectual Browsers Consortium (IBC)</span>, MANIT Bhopal and <span className="text-customTeal">Member at Zenith </span> - The Programming Club of MANIT , Bhopal.</p> <br />
      ...
      <div>
        <div className=" border-2 border-customTeal">
          <img src={myImg} alt="pic" className="relative bottom-2 right-2 h-[350px] transition-opacity duration-300 ease-in-out opacity-80 hover:opacity-100" />
        </div>
      </div>
    </div>
  )
